...
class AppInstrumentLog(SysAudit):
    ...
    # Fields
    instrument_id = models.CharField(max_length=36, verbose_name='ID Instrumento', null=False, blank=False, editable=True, unique=False)
