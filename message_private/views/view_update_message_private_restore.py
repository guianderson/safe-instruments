...
from message_private.forms import MessagePrivateUpdateTrashForm
from message_private.models import MessagePrivate


class MessagePrivateRestoreUpdateView(LoginRequiredMixin, PermissionRequiredMixin, SuccessMessageMixin, UpdateView):
    model = MessagePrivate
    form_class = MessagePrivateUpdateTrashForm
    template_name = 'message_private/update_message_restore_private.html'
    success_message = "Restaurado na Caixa de Entrada."
    ...
    def form_valid(self, form):
        try:
            form.instance.flag_trash_recipient = False
            return super(MessagePrivateRestoreUpdateView, self).form_valid(form)
