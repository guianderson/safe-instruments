...
class MessageTrashPrivateListView(LoginRequiredMixin, PermissionRequiredMixin, ListView):
    model = MessagePrivate
    paginate_by = 15
    template_name = 'message_private/list_message_trash_private.html'
    ...
    def get_queryset(self):
        ...
        queryset = MessagePrivate.objects.filter(recipient_message=self.request.user, flag_trash_recipient=True,
