...
class MessageReadPrivateDetailView(LoginRequiredMixin, PermissionRequiredMixin, DetailView):
    model = MessagePrivate
    form_class = MessagePrivateForm
    template_name = 'message_private/detail_message_read_private.html'
